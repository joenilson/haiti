    ...
    private function share_extensions() {
        $extensions = array(
            array(
                ...
                'page_to' => __CLASS__,
                'type' => 'head',
                'text' => '<script src="' . FS_PATH . 'plugins/haiti/view/js/2/daterangepicker.js" type="text/javascript"></script>',
                'params' => ''
            ),
            array(
                'name' => 'moment_js',
                ...
                'page_to' => __CLASS__,
                'type' => 'head',
                'text' => '<script src="' . FS_PATH . 'plugins/haiti/view/js/1/moment-with-locales.min.js" type="text/javascript"></script>',
                'params' => ''
            ),
            array(
                ...
                'page_to' => __CLASS__,
                'type' => 'head',
                'text' => '<link href="' . FS_PATH . 'plugins/haiti/view/css/daterangepicker.css" rel="stylesheet" type="text/css"/>',
                'params' => ''
            ),
            array(
                'name' => 'haiti_css',
                ...
                'page_to' => __CLASS__,
                'type' => 'head',
                'text' => '<link href="' . FS_PATH . 'plugins/haiti/view/css/haiti.css?build=' . rand(1, 1000) . '" rel="stylesheet" type="text/css"/>',
                'params' => ''
            ),
            array(
                'name' => 'haiti_commons_js',
                'page_from' => __CLASS__,
                'page_to' => __CLASS__,
                'type' => 'head',
                'text' => '<script src="' . FS_PATH . 'plugins/haiti/view/js/haiti_common.js" type="text/javascript"></script>',
                'params' => ''
            ),
            array(
